...
namespace GLTech.Structs
{
    ...
    public unsafe struct HorizontalList : IDisposable
    {
        private Node* first;
    ...
    [NativeCppClass]
    [StructLayout(LayoutKind.Sequential)]
    public unsafe struct HorizontalStruct
    {
        public Vector tl;
        public Vector br;
        public Texture texture;

        public static HorizontalStruct* Create(Vector topLeft, Vector bottomRight, Texture texture)
        {
        ...
        public bool Cull(Segment segment)
        {
