...
namespace Test
{
    partial class Program
    {
        ...
        public class Wolfenstein : Scene
        {
            Image textures = new(WE1M1.WolfTextures);
            Image background_buffer = new(WE1M1.Background);
            Image lula_buffer = new(WE1M1.lula);
            Image pt_buffer = new(WE1M1.pt);
            Image bolsonaro_buffer = new(WE1M1.bolsonaro);
            Image dolar_buffer = new(WE1M1._1dolar);
